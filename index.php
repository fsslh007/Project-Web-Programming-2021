            ...
            <section class="twt-login">
                <?php include 'includes/login.php';  ?>
                    <div class="slow-login">
                        <img class="login-bird" src="<?php echo BASE_URL . "/assets/images/FTU-logo.png"; ?>" alt="bird">
                        <button class="login-small-display signin-btn pri-btn">Log in</button>
                        <span class="front-para">See What’s Happening in Fatoni University Right Now!</span>
                        <span class="join">Join FTU Education Today.</span>
         ...
         <?php  include 'includes/signup-form.php' ?>
            ...
            <footer>
                <ul>
                    ...
                    <li>© 2022 - FTU Education</li>
                    <li style="color:#1DA1F2;"><b>- Developed By IT students -</b></li>
                </ul>
            </footer>
        </main>
