...
<head>
    ...
    <title> <?php echo $profileData->name; ?> (@<?php echo $profileData->username; ?>) | FTU Education</title>
        ...
        <div class="sidebar-left">
          <div class="grid-sidebar" style="margin-top: 12px">
            <div class="icon-sidebar-align">
              <img src="<?php echo BASE_URL . "/assets/images/FTU-logo-title.png"; ?>" alt="" height="50px" width="70px" />
            </div>
          </div>
